...
<div class="container">
    <div class="row">
        <div class="col-12">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-6">
                        <div class="page-title-content">
                            ...
                            <p class="mb-0">Isi form di bawah untuk menambahkan instansi baru.</p>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('agencies/store') }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select id="government_unit_id" name="government_unit_id" class="form-select @error('government_unit_id') is-invalid @enderror">
                                <option value="">- Pilih -</option>
                                @foreach ($units as $unit)
                                    <option value="{{ $unit->id }}" {{ old('government_unit_id') == $unit->id ? 'selected' : '' }}>
                                        {{ $unit->name }}
                                    </option>
                                @endforeach
                            </select>
